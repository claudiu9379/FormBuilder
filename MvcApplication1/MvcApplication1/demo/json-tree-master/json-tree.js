            ...
            var template =
                ...
                '<ul ng-hide="node.isCollapsed">' +
                    '<li ng-repeat="key in utils.keys(json) track by key">' +
                        '<div draggable>' +
                            '<label  class="key control-label" ng-click="utils.clickNode(childs[key])" >{{ key }}: </label>' +
                            '<span ng-hide="childs[key].isObject()">' +
                                ...
                                '<input ng-if="childs[key].type() !== \'number\' && childs[key].type() !== \'function\'" type="text" ng-model="json[key]" ng-change="utils.validateNode(key)"/>' +
                            '</span>' +
            ...
            return {
                ...
                controller: function($scope){
                    ...
                    $scope.utils = {
                        ...
                        keys: function(obj){
                            ...
                            if(obj instanceof Object)
                            {
                                  ...
                                  {
                                      if (tmp[i] != '$$hashKey' && tmp[i] != 'type' && typeof obj[tmp[i]] !== 'function')
                                    {
                                        rez.push(tmp[i]);
                                    }
                                  }
                    ...
                    $scope.node = {
                        ...
                        isFunction: function(){
                            return angular.isFunction($scope.json)
                        },
